package com.paweljarosz.twpro.dao;
...
import com.paweljarosz.twpro.model.UserConnection;
import com.paweljarosz.twpro.model.UserProfile;
...
public class UsersDao {
    ...
    public void createUser(String userId, UserProfile profile) {
        if (LOG.isDebugEnabled()) {
            LOG.debug("SQL INSERT ON users, user_roles and userProfile: " + userId + " with profile: " +
                profile.getEmail() + ", " +
        ...
        jdbcTemplate.update("INSERT into user_roles(username,role) values(?,?)",userId,"USER");
